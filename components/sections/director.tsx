        ...
        <FadeIn>
          <div className="grid items-center gap-8 rounded-3xl border border-border bg-card p-6 shadow-sm sm:p-10 lg:grid-cols-[280px_1fr]">
            <div className="mx-auto w-full max-w-[280px]">
              <div className="relative aspect-square overflow-hidden rounded-2xl ring-4 ring-secondary">
                <Image
                  src="/images/md.jpeg"
                  alt="মোঃ মিরাজ ইসলাম"
                  fill
            ...
            <div>
              ...
              <p className="mt-3 text-base leading-relaxed text-foreground text-pretty sm:text-lg">
                প্রিয় শিক্ষার্থী, নার্সিং একটি মহান পেশা — সেবা ও সম্মানের। ISC
                Expo - Icon Skill & Career Expo প্রতিষ্ঠার পেছনে আমাদের একটাই
                স্বপ্ন: খুলনার প্রতিটি মেধাবী শিক্ষার্থী যেন সঠিক দিকনির্দেশনা
                পেয়ে তার কাঙ্ক্ষিত প্রতিষ্ঠানে ভর্তি হতে পারে। অভিজ্ঞ
                শিক্ষকমণ্ডলী, আধুনিক পাঠদান পদ্ধতি ও আন্তরিক পরিবেশে আমরা আপনার
                পাশে আছি।
              </p>
