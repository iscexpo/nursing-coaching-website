...
type RequestWithNextUrl = Request & { nextUrl?: { pathname: string } }
...
export async function rateLimit(
  ...
  const maybeNextUrl = request as RequestWithNextUrl
  const route = maybeNextUrl.nextUrl
    ? maybeNextUrl.nextUrl.pathname
