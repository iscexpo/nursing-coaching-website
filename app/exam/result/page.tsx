    ...
    <>
      ...
      <main className="min-h-screen bg-secondary/20 py-8">
        <div className="mx-auto max-w-3xl px-4">
          <div className="overflow-hidden rounded-2xl border border-border bg-card shadow-sm">
            <div className="bg-brand p-6 text-center text-brand-foreground">
              ...
              <p className="text-sm opacity-80">
                {result.subject || 'পরীক্ষা'} মডেল টেস্ট
              </p>
            </div>
          ...
          {questions.length > 0 && (
            <>
              <h2 className="mt-8 mb-4 font-heading text-lg font-bold text-foreground">
                উত্তর পর্যালোচনা
              </h2>
                            ...
                            {q.options.map((opt, j) => {
                              ...
                              return (
                                ...
                                >
                                  ...
                                  {opt}
                                  {isAnswer && (
                                    <CheckCircle2 className="ml-auto size-3" />
                                  )}
                                  {isSelected && !isAnswer && (
                                    <XCircle className="ml-auto size-3" />
                                  )}
                                </div>
                              )
                            })}
